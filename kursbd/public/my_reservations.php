            ...
            <div class="container">
                <div class="main__inner">
                    ...
                    <div class="room__container">
                            <?php $reservations = get_reservations() ?>
                            <?php if ($reservations): ?>
                                <?php foreach ($reservations as $reservation): ?>
                                <div class="room__item">
                                    <img src="<?php echo $reservation['image']; ?>" name="img" alt="Ошибка при загрузке изображения!">
                                    <span><?php echo $reservation['username'] ?></span>
                                    <span><?php echo $reservation['name'] ?></span>
                                    <span><?php echo $reservation['category'] ?></span>
                                    <span><?php echo $reservation['price'] ?></span>
                                    <span><?php echo $reservation['city'] ?></span>
                                    <span><?php echo $reservation['address'] ?></span>
                                </div>
                                <?php endforeach; ?>
                            <?php endif; ?> 
                        </div>
