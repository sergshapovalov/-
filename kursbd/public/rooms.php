                ...
                <div class="main__inner">
                    <div class="left__menu">
                        <nav class="left-menu__item">
                            ...
                            <a href="rooms.php" class="left-menu__link left-menu__active">Комнаты</a>
                    ...
                    <div class="room__container">
                        ...
                        <div class="room__item">
                            <input type="hidden" name="action" value="<?php echo $room['id']; ?>">
                            <img src="<?php echo $room['image']; ?>" alt="Ошибка при загрузке изображения!">
                            <span><?php echo $room['name']; ?></span>
                            <span>Цена: <?php echo $room['price']; ?></span>
                            <span>Город: <?php echo $room['city']; ?></span>
                            <span>Адрес: <?php echo $room['address']; ?></span>
                            <?php if ($room['description'] !== null): ?>
                            <span>Описание: <?php echo $room['description']; ?></span>
                            <?php endif; ?>
